...
object DoHProvider {
     ...
     *
     * @return a DNS modified [OkHttpClient.Builder] instance
     * */
    ...
    /**
     *
     * Returns a new OkHttpClient.Builder with AdGuard DNS. AdGuard "Default" DNS
     * works too but for the sake of making sure no site is blacklisted, we use "Unfiltered"
     *
     * @return a DNS modified [OkHttpClient.Builder] instance
     * */
